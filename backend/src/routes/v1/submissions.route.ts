...
router.get(
    '/list',
    auth('getGuarantors'),
    validate(guarantorSubmissionValidation.getGuarantorSubmissions),
    guarantorSubmissionController.getGuarantorSubmissions
);
...
router.delete(
    ...
    validate(guarantorSubmissionValidation.deleteGuarantorSubmission),
    guarantorSubmissionController.deleteGuarantorSubmission
);
