...
router.post('/submit', auth('manageGuarantors'), validate(guarantorSubmissionValidation.createGuarantorSubmission), guarantorSubmissionController.createGuarantorSubmission);
// PUT /api/guarantor/:id
router.put('/:id', auth('manageGuarantors'), validate(guarantorSubmissionValidation.updateGuarantorSubmission), guarantorSubmissionController.updateGuarantorSubmission);
// GET /api/guarantor/:id
router.get('/:id', auth('getGuarantors'), validate(guarantorSubmissionValidation.getGuarantorSubmission), guarantorSubmissionController.getGuarantorSubmission);
