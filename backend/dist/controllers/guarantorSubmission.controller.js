import { guarantorSubmissionService } from "../services/index.js";
...
const createGuarantorSubmission = catchAsyncWithAuth(async (req, res) => {
    const { guarantor_name, relationship_to_borrower, address, date_of_birth, occupation, employer_or_business, linkedin_profile, company_registration_number, known_associations, comments } = req.body;
...
const updateGuarantorSubmission = catchAsyncWithAuth(async (req, res) => {
    ...
    if (req.body.guarantor_name)
        updateData.guarantorName = req.body.guarantor_name;
    if (req.body.relationship_to_borrower)
        updateData.relationshipToBorrower = req.body.relationship_to_borrower;
    if (req.body.address) {
        if (req.body.address.street)
            updateData.streetAddress = req.body.address.street;
        ...
        if (req.body.address.zip)
            updateData.zip = req.body.address.zip;
    }
    if (req.body.date_of_birth)
        updateData.dateOfBirth = new Date(req.body.date_of_birth);
    if (req.body.occupation)
        updateData.occupation = req.body.occupation;
    if (req.body.employer_or_business)
        updateData.employerOrBusiness = req.body.employer_or_business;
    if (req.body.linkedin_profile !== undefined)
        updateData.linkedinProfile = req.body.linkedin_profile || null;
    ...
    if (req.body.known_associations)
        updateData.knownAssociations = req.body.known_associations;
