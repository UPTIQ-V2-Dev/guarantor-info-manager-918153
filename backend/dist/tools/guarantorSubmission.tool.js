...
const createGuarantorSubmissionTool = {
    id: 'guarantor_create',
...
const getGuarantorSubmissionsTool = {
    id: 'guarantor_list',
...
const getGuarantorSubmissionTool = {
...
const updateGuarantorSubmissionTool = {
    id: 'guarantor_update',
...
const deleteGuarantorSubmissionTool = {
    id: 'guarantor_delete',
...
const getDashboardStatsTool = {
    ...
    outputSchema: z.object({
        ...
        verified: z.number(),
        rejected: z.number(),
        recent_submissions: z.array(z.object({
            id: z.string(),
            guarantorName: z.string(),
            relationshipToBorrower: z.string(),
            recordStatus: z.string(),
...
export const guarantorSubmissionTools = [
